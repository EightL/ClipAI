...
const api = {
  ...
  setMaxOutputTokens: (tokens) => ipcRenderer.invoke('clipai:set-max-output-tokens', tokens),
  ...
  formatShortcutWithIcons: (shortcut, forDisplay) => ipcRenderer.invoke('clipai:format-shortcut-with-icons', shortcut, forDisplay),
